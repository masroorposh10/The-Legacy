    ...
    Statement = [
      {
        ...
        Resource = [
          "arn:aws:logs:*:*:*",
          "*",
          "${aws_dynamodb_table.thelastshow1234.arn}",
          "arn:aws:ssm:ca-central-1:341576245914:parameter/the-last-show/cloudinaryapikey",
          "arn:aws:ssm:ca-central-1:341576245914:parameter/the-last-show/cloudinarysecret",
          "arn:aws:polly:*:*:*"
        ]
      },
      {
        ...
        Resource = "arn:aws:ssm:ca-central-1:341576245914:parameter/the-last-show/cloudinaryapikey"
      },
      {
        Effect   = "Allow"
        Action   = "ssm:GetParametersByPath"
        Resource = "arn:aws:ssm:ca-central-1:341576245914:parameter/the-last-show/cloudinarysecret"
      }
    ]
  })
}
  ...
  "Statement": [
    {
      ...
      "Resource": ["arn:aws:logs:*:*:*", "${aws_dynamodb_table.thelastshow1234.arn}"],
      "Effect": "Allow"
    }
  ]
}
...
resource "aws_dynamodb_table" "thelastshow1234" {
  name         = "thelastshow1234"
